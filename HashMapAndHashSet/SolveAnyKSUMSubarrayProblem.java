...
//Solve any K SUM Subarray Problem
public class SolveAnyKSUMSubarrayProblem {
    public static void main(String[] args) {
        int []arr = {2, 8, 2, 6, -6, 3, 2};
        int []brr = {10, 0, 0, 5, 2, 7};
        ...
        System.out.println("KSumSubarray -> ["+res.get(0)+" , "+res.get(1)+"]");

        int longestKSumSubarray = findLongestKSumSubarray(brr, 5);
        System.out.println("longestKSumSubarray : "+longestKSumSubarray);

        int totalKSumSubarray = findTotalKSumSubarray(brr, 5);
        System.out.println("totalKSumSubarray : "+totalKSumSubarray);
    }
    ...
    private static ArrayList<Integer> findKSumSubarray(int[] arr, int k) {
